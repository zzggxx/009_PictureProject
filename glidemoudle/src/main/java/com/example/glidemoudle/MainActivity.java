...
import com.example.glidemoudle.http.ProgressListener;
...
//                获取到将要放置到imageview中的图片,此时可以进行任意的操作.
    ...
    private void loadImg() {
        ...
        // TODO: 2018/10/29 进度回调错误.
        ProgressInterceptor.addListener(img_path, new ProgressListener() {
            @Override
            public void onProgress(int progress) {
                mProgressBar.setProgress(progress);
                Log.i(TAG, "onProgress__: " + progress);
            }
        });
        ...
        Glide.with(this)
                ...
                .into(new GlideDrawableImageViewTarget(mImageView) {
                    ...
                    public void onLoadStarted(Drawable placeholder) {
                        ...
                        ProgressInterceptor.removeListener(img_path);
                    }
                });
    }
}
